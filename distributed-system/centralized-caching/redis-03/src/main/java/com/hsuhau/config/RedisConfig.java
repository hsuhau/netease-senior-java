...
import com.hsuhau.controller.WebSocketChatHandler;
...
public class RedisConfig {
    ...
    public WebSocketConfigurer webSocketConfigurer(WebSocketChatHandler websocketChatHandler) {
        return webSocketHandlerRegistry -> webSocketHandlerRegistry.addHandler(websocketChatHandler, "/ws/chat").setAllowedOrigins("*");
    }
}